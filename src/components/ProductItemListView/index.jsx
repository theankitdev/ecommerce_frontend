    ...
    >
      ...
      <div className="imgWrapper w-[150px] sm:w-[220px]  relative group overflow-hidden group">
        ...
        <img
          ...
          className="w-full h-full object-cover absolute top-0 left-0 opacity-0 group-hover:opacity-100 group-hover:scale-110 transition duration-300"
        />
      ...
      <div className="info flex-1 py-2 px-8 flex flex-col justify-between">
        <div>
          <h6 className="text-sm text-gray-500 mb-1 hover:text-[#ff5252]">
            {product.brand}
          </h6>

          <h3 className="text-lg font-semibold mb-1 line-clamp-1 hover:text-[#ff5252]">
            {product.title}
          </h3>
